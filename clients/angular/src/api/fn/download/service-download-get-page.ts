...
export interface ServiceDownloadGetPage$Params {
...
export function serviceDownloadGetPage(http: HttpClient, rootUrl: string, params?: ServiceDownloadGetPage$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Download>>> {
  const rb = new RequestBuilder(rootUrl, serviceDownloadGetPage.PATH, 'get');
  if (params) {
...
serviceDownloadGetPage.PATH = '/download';

export { serviceDownloadGetPage as getPage };
